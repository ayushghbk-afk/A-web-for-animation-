...
/* ============================================================
   ...
   Examples:
     ...
     node tools/build-ae-assets.mjs --all           # all 900
...
const bundleBase = selected.length === items.length ? 'motion-lab-900-effect-bundle' : 'motion-lab-' + selected.length + '-effect-starter-kit';
