...
{ id: 'dice-roll', title: 'Rolling Dice', cat: '3d', tags: ['3d', 'css'],
  html: '<div class="dd3"><i class="shdx"></i><div class="flx3"><div class="die3"><i class="p1"></i><i class="p2"></i><i class="p3"></i><i class="p4"></i><i class="p5"></i><i class="p6"></i></div></div></div>',
  css: '.dd3{position:relative;width:170px;height:158px;perspective:780px}\n.shdx{position:absolute;left:50%;bottom:0;width:86px;height:18px;margin-left:-43px;border-radius:50%;background:rgba(0,0,0,.6);filter:blur(6px);animation:shd3 2.6s ease-in-out infinite}\n.flx3{position:absolute;inset:0;display:grid;place-items:center;transform-style:preserve-3d;animation:flt3 2.6s ease-in-out infinite}\n.die3{position:relative;width:92px;height:92px;transform-style:preserve-3d;animation:diego 9s linear infinite}\n.die3 i{position:absolute;inset:0;border-radius:17px;background:#f3eddf;background-color:#f3eddf;box-shadow:inset 0 -12px 18px -12px rgba(0,0,0,.35),inset 0 2px 6px rgba(255,255,255,.6)}\n.die3 .p1{transform:translateZ(46px);background-image:radial-gradient(circle at 50% 50%,#261d4a 0 16%,transparent 20%)}\n.die3 .p2{transform:rotateY(180deg) translateZ(46px);background-image:radial-gradient(circle at 28% 28%,#261d4a 0 16%,transparent 20%),radial-gradient(circle at 72% 72%,#261d4a 0 16%,transparent 20%)}\n.die3 .p3{transform:rotateY(90deg) translateZ(46px);background-image:radial-gradient(circle at 30% 30%,#261d4a 0 16%,transparent 20%),radial-gradient(circle at 50% 50%,#261d4a 0 16%,transparent 20%),radial-gradient(circle at 70% 70%,#261d4a 0 16%,transparent 20%)}\n.die3 .p4{transform:rotateY(-90deg) translateZ(46px);background-image:radial-gradient(circle at 28% 28%,#261d4a 0 16%,transparent 20%),radial-gradient(circle at 72% 28%,#261d4a 0 16%,transparent 20%),radial-gradient(circle at 28% 72%,#261d4a 0 16%,transparent 20%),radial-gradient(circle at 72% 72%,#261d4a 0 16%,transparent 20%)}\n.die3 .p5{transform:rotateX(90deg) translateZ(46px);background-image:radial-gradient(circle at 28% 28%,#261d4a 0 16%,transparent 20%),radial-gradient(circle at 72% 28%,#261d4a 0 16%,transparent 20%),radial-gradient(circle at 50% 50%,#261d4a 0 16%,transparent 20%),radial-gradient(circle at 28% 72%,#261d4a 0 16%,transparent 20%),radial-gradient(circle at 72% 72%,#261d4a 0 16%,transparent 20%)}\n.die3 .p6{transform:rotateX(-90deg) translateZ(46px);background-image:radial-gradient(circle at 28% 28%,#261d4a 0 16%,transparent 20%),radial-gradient(circle at 72% 28%,#261d4a 0 16%,transparent 20%),radial-gradient(circle at 28% 52%,#261d4a 0 16%,transparent 20%),radial-gradient(circle at 72% 52%,#261d4a 0 16%,transparent 20%),radial-gradient(circle at 28% 76%,#261d4a 0 16%,transparent 20%),radial-gradient(circle at 72% 76%,#261d4a 0 16%,transparent 20%)}\n@keyframes diego{from{transform:rotateX(-18deg) rotateY(0)}to{transform:rotateX(-18deg) rotateY(360deg)}}\n@keyframes flt3{0%,100%{transform:translateY(0)}50%{transform:translateY(-12px)}}\n@keyframes shd3{0%,100%{transform:scale(1);opacity:.65}50%{transform:scale(.78);opacity:.35}}'
},

{ id: 'flip-tiles-3d', title: 'Flip Tiles', cat: '3d', tags: ['css', 'flip'],
  html: '<div class="ft3"><i></i><i></i><i></i><i></i><i></i></div>',
  css: '\n.ft3{display:flex;gap:8px;perspective:600px}\n.ft3 i{width:34px;height:46px;border-radius:6px;background:linear-gradient(150deg,#7c5cff,#a855f7);transform-style:preserve-3d;animation:ft3 1.6s ease-in-out infinite;transform-origin:center}\n.ft3 i:nth-child(1){animation-delay:0s}.ft3 i:nth-child(2){animation-delay:.1s}.ft3 i:nth-child(3){animation-delay:.2s}.ft3 i:nth-child(4){animation-delay:.3s}.ft3 i:nth-child(5){animation-delay:.4s}\n.ft3 i:nth-child(2n){background:linear-gradient(150deg,#22d3ee,#7c5cff)}\n@keyframes ft3{0%,100%{transform:rotateX(0)}50%{transform:rotateX(-180deg)}}\n'
}
,

{ id: 'swing-pendulum', title: 'Swing Chain', cat: '3d', tags: ['css', 'pendulum'],
  html: '<div class="pd3"><b></b><b></b><b></b><b></b><b></b></div>',
  css: '\n.pd3{position:relative;display:flex;align-items:flex-start;gap:4px;height:120px;border-top:3px solid rgba(160,160,210,.3);padding-top:10px;width:190px;transform-style:preserve-3d}\n.pd3 b{width:12px;height:40px;border-radius:6px;background:linear-gradient(#a855f7,#7c5cff);transform-origin:top center;animation:pd3 1.4s cubic-bezier(.6,.05,.4,.9) infinite;transform:perspective(400px) rotateX(30deg)}\n.pd3 b:nth-child(1){animation-delay:-.2s}.pd3 b:nth-child(2){animation-delay:-.4s}.pd3 b:nth-child(3){animation-delay:-.6s}.pd3 b:nth-child(4){animation-delay:-.8s}.pd3 b:nth-child(5){animation-delay:-1s}\n.pd3 b::after{content:"";position:absolute;bottom:-8px;left:50%;width:10px;height:10px;margin-left:-5px;border-radius:50%;background:#22d3ee;box-shadow:0 0 8px #22d3ee}\n@keyframes pd3{0%,100%{transform:rotate(-25deg)}50%{transform:rotate(25deg)}}\n'
}
,

{ id: 'fan-3d', title: 'Fan 3D', cat: '3d', tags: ['css', 'fan'],
  html: '<div class="fan3"><i></i><i></i><i></i><i></i></div>',
  css: '\n.fan3{position:relative;width:170px;height:150px;transform-style:preserve-3d;animation:fan3 5s linear infinite}\n.fan3 i{position:absolute;left:50%;top:50%;width:66px;height:66px;margin:-33px 0 0 -33px;border-radius:12px;transform-style:preserve-3d;display:grid;place-items:center}\n.fan3 i:nth-child(1){background:rgba(124,92,255,.85);transform:rotateY(0) translateZ(50px)}\n.fan3 i:nth-child(2){background:rgba(34,211,238,.85);transform:rotateY(90deg) translateZ(50px)}\n.fan3 i:nth-child(3){background:rgba(168,85,247,.85);transform:rotateY(180deg) translateZ(50px)}\n.fan3 i:nth-child(4){background:rgba(255,92,138,.85);transform:rotateY(270deg) translateZ(50px)}\n.fan3 i::after{content:attr(data-t);color:#fff;font:700 14px \'Space Grotesk\',sans-serif}\n@keyframes fan3{to{transform:rotateY(360deg)}}\n',
  js: 'var fs=root.querySelectorAll(".fan3 i");fs.forEach(function(i,j){i.setAttribute("data-t",["A","B","C","D"][j]);});'
}
,

{ id: 'cube-stack', title: 'Cube Stack', cat: '3d', tags: ['css', 'stack'],
  html: '<div class="cs3"><i></i><i></i><i></i></div>',
  css: '\n.cs3{display:flex;flex-direction:column;align-items:center;gap:2px;transform-style:preserve-3d;perspective:600px}\n.cs3 i{width:26px;height:26px;border-radius:5px;transform-style:preserve-3d;animation:cs3 1.6s ease-in-out infinite}\n.cs3 i:nth-child(1){background:#7c5cff}.cs3 i:nth-child(2){background:#a855f7;animation-delay:.15s}.cs3 i:nth-child(3){background:#22d3ee;animation-delay:.3s}\n@keyframes cs3{0%,100%{transform:rotateX(0) translateY(0)}50%{transform:rotateX(180deg) translateY(-6px)}}\n'
}
,

{ id: 'depth-parallax', title: 'Depth Parallax', cat: '3d', tags: ['js', 'parallax'],
  html: '<div class="dp3"><div class="ly ly1"></div><div class="ly ly2"></div><div class="ly ly3"><b>HOVER</b></div></div>',
  css: '\n.dp3{position:relative;width:210px;height:150px;border-radius:16px;overflow:hidden;transform-style:preserve-3d;background:linear-gradient(160deg,#1a1a34,#0b0b18)}\n.ly{position:absolute;border-radius:10px;transition:transform .15s ease-out}\n.ly1{left:12px;bottom:14px;width:54px;height:34px;background:linear-gradient(120deg,#ff5c8a,#ff9d5c);box-shadow:0 14px 20px -8px #000}\n.ly2{left:76px;bottom:14px;width:70px;height:44px;background:linear-gradient(120deg,#7c5cff,#a855f7);box-shadow:0 14px 24px -8px #000}\n.ly3{right:16px;bottom:14px;width:60px;height:56px;background:linear-gradient(120deg,#22d3ee,#22c55e);display:grid;place-items:center;box-shadow:0 14px 24px -8px #000}\n.ly3 b{font:800 11px \'Space Grotesk\',sans-serif;color:#05121a;letter-spacing:.05em}\n.dp3::before{content:"";position:absolute;left:0;right:0;bottom:0;height:20px;background:rgba(0,0,0,.25);border-radius:50% 50% 0 0;transform:translateY(6px)}\n',
  js: 'var el=root.querySelector(\'.dp3\'),l1=root.querySelector(\'.ly1\'),l2=root.querySelector(\'.ly2\'),l3=root.querySelector(\'.ly3\'),x=0,y=0,cx=0,cy=0;el.addEventListener(\'pointermove\',function(e){var r=el.getBoundingClientRect();cx=((e.clientX-r.left)/r.width-.5);cy=((e.clientY-r.top)/r.height-.5);});api.raf(function(){x+=(cx-x)*0.08;y+=(cy-y)*0.08;l1.style.transform=\'translate3d(\'+(-x*34)+\'px,\'+(-y*20)+\'px,0)\';l2.style.transform=\'translate3d(\'+(-x*18)+\'px,\'+(-y*12)+\'px,0)\';l3.style.transform=\'translate3d(\'+(x*6)+\'px,\'+(y*8)+\'px,0)\';});'
}
,

{ id: 'isometric-float', title: 'Isometric Float', cat: '3d', tags: ['css', 'iso'],
  html: '<div class="is3"><div><i></i><b></b><span></span></div></div>',
  css: '\n.is3{perspective:600px}\n.is3>div{position:relative;width:90px;height:90px;transform-style:preserve-3d;animation:is3 3s ease-in-out infinite}\n.is3 i{position:absolute;inset:0;background:linear-gradient(135deg,#7c5cff,#22d3ee);clip-path:polygon(50% 0,100% 25%,50% 50%,0 25%);}\n.is3 b{position:absolute;top:22px;left:22px;width:46px;height:46px;transform:rotate(45deg);background:rgba(124,92,255,.5);backdrop-filter:blur(2px)}\n.is3 span{position:absolute;inset:0;transform:translateZ(-30px) rotate(0);background:rgba(34,211,238,.25);clip-path:polygon(50% 0,100% 25%,50% 50%,0 25%);filter:blur(6px)}\n@keyframes is3{0%,100%{transform:rotateZ(-2deg)}50%{transform:rotateZ(2deg) translateY(-6px)}}\n'
}
,

{ id: 'sphere-dots', title: 'Dot Sphere', cat: '3d', tags: ['css', 'sphere'],
  html: '<div class="ds3"><i></i><i></i><i></i><i></i><i></i></div>',
  css: '\n.ds3{position:relative;width:80px;height:80px;transform-style:preserve-3d;animation:ds3r 6s linear infinite}\n.ds3 i{position:absolute;inset:0;border-radius:50%;display:grid;place-items:center;transform-style:preserve-3d;box-shadow:inset 0 0 0 1.5px rgba(124,92,255,.4)}\n.ds3 i::before{content:"";width:10px;height:10px;border-radius:50%;background:#22d3ee;box-shadow:0 0 8px #22d3ee}\n.ds3 i:nth-child(1){transform:rotateY(0) rotateX(0)}\n.ds3 i:nth-child(2){transform:rotateY(60deg)}\n.ds3 i:nth-child(3){transform:rotateY(120deg)}\n.ds3 i:nth-child(4){transform:rotateX(60deg)}\n.ds3 i:nth-child(5){transform:rotateX(120deg)}\n@keyframes ds3r{to{transform:rotateX(360deg) rotateY(360deg)}}\n'
}
